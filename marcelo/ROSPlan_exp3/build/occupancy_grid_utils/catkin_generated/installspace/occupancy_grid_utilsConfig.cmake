...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'occupancy_grid_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/paravisi/ROSPlan/install/${idir}'.  Ask the maintainer 'jservos <jservos@clearpathrobotics.com>' to fix it.")
    endif()
