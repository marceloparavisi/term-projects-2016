...
if(NOT "include;/opt/ros/indigo/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosplan_planning_system' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/paravisi/ROSPlan/install/${idir}'.  Ask the maintainer 'michael <michael.cashmore@kcl.ac.uk>' to fix it.")
    endif()
