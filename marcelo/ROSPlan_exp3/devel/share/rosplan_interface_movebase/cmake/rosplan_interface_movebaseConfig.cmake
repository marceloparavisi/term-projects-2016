...
if("TRUE" STREQUAL "TRUE")
  set(rosplan_interface_movebase_SOURCE_PREFIX /home/paravisi/ROSPlan/src/rosplan/rosplan_interface_movebase)
  set(rosplan_interface_movebase_DEVEL_PREFIX /home/paravisi/ROSPlan/devel)
  ...
  set(rosplan_interface_movebase_INSTALL_PREFIX /home/paravisi/ROSPlan/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosplan_interface_movebase' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'michael <michael.cashmore@kcl.ac.uk>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosplan_interface_movebase' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/paravisi/ROSPlan/src/rosplan/rosplan_interface_movebase/${idir}'.  Ask the maintainer 'michael <michael.cashmore@kcl.ac.uk>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosplan_interface_movebase_dep}_FOUND)
      find_package(${rosplan_interface_movebase_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosplan_interface_movebase_dep} REQUIRED ${depend_list})
  endif()
